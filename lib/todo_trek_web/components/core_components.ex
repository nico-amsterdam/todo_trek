defmodule TodoTrekWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(TodoTrekWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(TodoTrekWeb.Gettext, "errors", msg, opts)
    end
  end
